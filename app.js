...
function computeAnnual(params){
  ...
  const monthly = {gross:gross/12, net:(net-esop_match_net)/12, income_tax:income_tax/12, cpp:cpp_total/12, ei:eiPrem/12, health:annual_health/12, pension:pension/12, esop:esop/12, esop_match_net:esop_match_net/12};
